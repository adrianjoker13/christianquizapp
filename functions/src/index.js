...
exports.updateLeaderboard = functions.pubsub.onSchedule("every 24 hours", () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const usersRef = db.collection("users");
        const leaderboardRef = db.collection("leaderboard");
        // Fetch top 10 users based on XP
        const snapshot = yield usersRef.orderBy("xp", "desc").limit(10).get();
        // Clear existing leaderboard
        const leaderboardDocs = yield leaderboardRef.get();
